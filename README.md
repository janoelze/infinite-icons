...
last update: 2023-07-12 16:27

|  |  |  |  |
| ---- | ---- | ---- | ---- |
| ![icons/icon-rocket-launch](icons/icon-rocket-launch.svg) | ![icons/icon-fingerprint](icons/icon-fingerprint.svg) | ![icons/magnify-glass-icon](icons/magnify-glass-icon.svg) | ![icons/icon-umbrella-rain](icons/icon-umbrella-rain.svg) 
| icon-rocket-launch | icon-fingerprint | magnify-glass-icon | icon-umbrella-rain 
...
| ![icons/icon-starfish-sea](icons/icon-starfish-sea.svg) | ![icons/icon-lightning](icons/icon-lightning.svg) | ![icons/icon-thunderstorm](icons/icon-thunderstorm.svg) | ![icons/icon-umbrella](icons/icon-umbrella.svg) 
| icon-starfish-sea | icon-lightning | icon-thunderstorm | icon-umbrella 
...
| icon-owl | icon-star-rocket | icon-trophy | icon-sun 
| ![icons/icon-phone](icons/icon-phone.svg) | ![icons/icon-gears](icons/icon-gears.svg) | ![icons/icon-heart](icons/icon-heart.svg) | ![icons/icon-star-sunflower](icons/icon-star-sunflower.svg) 
| icon-phone | icon-gears | icon-heart | icon-star-sunflower 
...
| icon-graduation-cap | icon-keyhole | icon-health-heart | icon-rocket-space 
...
| ![icons/icon-mountain](icons/icon-mountain.svg) | ![icons/icon-weather-sun](icons/icon-weather-sun.svg) | ![icons/icon-magnifyingglass](icons/icon-magnifyingglass.svg) | ![icons/icon-key](icons/icon-key.svg) 
| icon-mountain | icon-weather-sun | icon-magnifyingglass | icon-key 
...
| ![icons/icon-flag](icons/icon-flag.svg) | ![icons/icon-sunrise](icons/icon-sunrise.svg) | ![icons/shopping-cart-icon](icons/shopping-cart-icon.svg) | ![icons/icon-star-lightbulb](icons/icon-star-lightbulb.svg) 
| icon-flag | icon-sunrise | shopping-cart-icon | icon-star-lightbulb 
...
| ![icons/icon-umbrella-shield](icons/icon-umbrella-shield.svg) | ![icons/icon-home](icons/icon-home.svg) | ![icons/icon-trophy-09](icons/icon-trophy-09.svg) | ![icons/icon-lightning-bolt](icons/icon-lightning-bolt.svg) 
| icon-umbrella-shield | icon-home | icon-trophy-09 | icon-lightning-bolt 
...
| ![icons/icon-microphone](icons/icon-microphone.svg) | ![icons/icon-vintage-key](icons/icon-vintage-key.svg) | ![icons/icon-business-chart](icons/icon-business-chart.svg) | ![icons/icon-briefcase](icons/icon-briefcase.svg) 
| icon-microphone | icon-vintage-key | icon-business-chart | icon-briefcase 
| ![icons/crown-icon](icons/crown-icon.svg) | ![icons/icon-anchor](icons/icon-anchor.svg) | ![icons/bicycle-icon](icons/bicycle-icon.svg) | ![icons/icon-cogwheel](icons/icon-cogwheel.svg) 
| crown-icon | icon-anchor | bicycle-icon | icon-cogwheel 
...
| ![icons/icon-cupcake](icons/icon-cupcake.svg) | ![icons/icon-coffee-cup](icons/icon-coffee-cup.svg) | ![icons/icon-compass-rose](icons/icon-compass-rose.svg) | ![icons/gear-cogs-icon](icons/gear-cogs-icon.svg) 
| icon-cupcake | icon-coffee-cup | icon-compass-rose | gear-cogs-icon 
| ![icons/icon-chat](icons/icon-chat.svg) | ![icons/hourglass-time-icon](icons/hourglass-time-icon.svg) | ![icons/icon-chart](icons/icon-chart.svg) | ![icons/icon-cloud](icons/icon-cloud.svg) 
| icon-chat | hourglass-time-icon | icon-chart | icon-cloud 
| ![icons/icon-cog](icons/icon-cog.svg) | ![icons/camera-icon](icons/camera-icon.svg) | ![icons/bookshelf-icon](icons/bookshelf-icon.svg) | ![icons/icon-bookmark](icons/icon-bookmark.svg) 
| icon-cog | camera-icon | bookshelf-icon | icon-bookmark 
