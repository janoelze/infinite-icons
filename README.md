...
| ![icons/icon-owl](icons/icon-owl.svg) | ![icons/hourglass-icon](icons/hourglass-icon.svg) | ![icons/icon-star-rocket](icons/icon-star-rocket.svg) | ![icons/icon-trophy](icons/icon-trophy.svg) 
| icon-owl | hourglass-icon | icon-star-rocket | icon-trophy 
...
| ![icons/gear-cogs-icon](icons/gear-cogs-icon.svg) | ![icons/icon-chat](icons/icon-chat.svg) | ![icons/icon-user](icons/icon-user.svg) | ![icons/icon-star-cloud](icons/icon-star-cloud.svg) 
| gear-cogs-icon | icon-chat | icon-user | icon-star-cloud 
...
| ![icons/icon-microphone](icons/icon-microphone.svg) | ![icons/icon-vintage-key](icons/icon-vintage-key.svg) | ![icons/bicycle-icon](icons/bicycle-icon.svg) | ![icons/camera-icon](icons/camera-icon.svg) 
| icon-microphone | icon-vintage-key | bicycle-icon | camera-icon 
